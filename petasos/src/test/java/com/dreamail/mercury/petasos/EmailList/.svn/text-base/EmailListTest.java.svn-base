package com.dreamail.mercury.petasos.EmailList;
...
public class EmailListTest {
     ...
     */
    @Test
    public void testEmailList() throws JiBXException, FileNotFoundException {
        ...
        FileInputStream in = new FileInputStream(this.getClass().getResource("/").getPath() + File.separator + "EmailList.xml");
