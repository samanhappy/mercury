...
public class IMAPStore extends Store 
    ...
    public void SetIDCommand(String s){
			iDCommand = s;
    }
    /*
	...
	if(iDCommand!=null&&iDCommand.length()>0){
	    Response[] r = p.command(iDCommand, null);
	    if (!r[r.length-1].isOK()) throw new ProtocolException(r[r.length-1].toString());
	}
	/*
