...
public abstract class Service {
    ...
    private boolean useXYMCookieAuth = false;
    
    public boolean isUseXYMCookieAuth() {
		return useXYMCookieAuth;
	}

	public void setUseXYMCookieAuth(boolean useXYMCookieAuth) {
		this.useXYMCookieAuth = useXYMCookieAuth;
	}
