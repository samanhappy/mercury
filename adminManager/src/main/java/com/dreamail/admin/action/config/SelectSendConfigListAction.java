...
public class SelectSendConfigListAction extends ActionSupport {

	private static final long serialVersionUID = 1L;

	private List<Clickoo_mail_send_server> servers = new ArrayList<Clickoo_mail_send_server>();
	
	@Override
	public String execute() throws Exception {
		servers = new SendServerDao().getAllSendServer();
		return SUCCESS;
	}

	public List<Clickoo_mail_send_server> getServers() {
		return servers;
	}

	public void setServers(List<Clickoo_mail_send_server> servers) {
