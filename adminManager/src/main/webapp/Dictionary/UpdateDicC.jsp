...
<HTML>
	...
	<body class="PopupWinBody1">
		<form id="Form1" method="post" action="<%=request.getContextPath()%>/updateDicC.do?dicCid=${tDiccontent.dicid}">
									...
									<table  cellSpacing="0" cellPadding="0" width="474" align="center">
										<tr>
											...
											<td  align="left"  width="374px" >
												<input type="text" name="dicname" id="txtDeptName" size="30" Class="Text" value="${tDiccontent.dicname}" >
											</td>
										...
										<tr>
											...
											<td style="HEIGHT: 35px" align="left" >
												<input type="text" name="notation" id="txtRemark" size="50" Class="Text" Width="100%" value="${tDiccontent.notation}">
											</td>
										</tr>
									</table>
