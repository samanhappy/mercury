...
<s:form id="Form1" action="login">
	<s:hidden id="username"></s:hidden>
	<s:hidden id="password"></s:hidden>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<table width="100%" height="100%" border="0" cellpadding="0"
								cellspacing="0">
								<tr>
									<td valign="top"><img src="images/pic_03.gif" height="82" />
									</td>
								</tr>
								<tr>
									<td height="112" valign="middle" background="images/pic_04.gif">
										...
										<tr>
											...
											<table width="180" border="0" align="center" cellpadding="0"
												...
												<tr>
													...
													<div align="left">帐 号 <strong>:</strong></div>
													</td>
													<td width="100">
													<div align="center">
														<input name="txtAccount" id="txtAccount" class="smallInput" type="text" style="WIDTH: 100px; HEIGHT: 20px" tabindex="1" />
													</div>
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td width="50" class="font10"
														style="padding-top: 3; padding-left: 0; padding-right: 0; padding-top: 3">
													<div align="left">密 码 <strong>:</strong></div>
													</td>
													<td width="100">
													<div align="center">
													<input type="password"
														name="txtPassword" id="txtPassword" class="smallInput"
											...
											<td width="101"><a href="#" onclick="Login()"
												...
												onmouseover="MM_swapImage('Image6', '', 'images/btn_login_hot.gif', 0)";><img
												src="images/btn_login.gif" name="Image6" width="42"
												height="44" border="0" id="Image6" /> </a></td>
										</tr>
										<tr>
