...
public class ArrayOfAttendeeConflictData {
    ...
    @XmlElements({
        @XmlElement(name = "IndividualAttendeeConflictData", required = true, type = IndividualAttendeeConflictData.class, nillable = true),
        @XmlElement(name = "GroupAttendeeConflictData", required = true, type = GroupAttendeeConflictData.class, nillable = true),
        @XmlElement(name = "UnknownAttendeeConflictData", required = true, type = UnknownAttendeeConflictData.class, nillable = true),
        @XmlElement(name = "TooBigGroupAttendeeConflictData", required = true, type = TooBigGroupAttendeeConflictData.class, nillable = true)
    })
