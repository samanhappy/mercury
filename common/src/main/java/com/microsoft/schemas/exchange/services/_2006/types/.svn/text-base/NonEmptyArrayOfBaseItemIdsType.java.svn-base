...
public class NonEmptyArrayOfBaseItemIdsType {
    ...
    @XmlElements({
        @XmlElement(name = "RecurringMasterItemId", required = true, type = RecurringMasterItemIdType.class),
        @XmlElement(name = "ItemId", required = true, type = ItemIdType.class),
        @XmlElement(name = "OccurrenceItemId", required = true, type = OccurrenceItemIdType.class)
    })
