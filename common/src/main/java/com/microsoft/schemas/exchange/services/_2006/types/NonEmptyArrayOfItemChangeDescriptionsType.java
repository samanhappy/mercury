...
public class NonEmptyArrayOfItemChangeDescriptionsType {
    ...
    @XmlElements({
        @XmlElement(name = "SetItemField", required = true, type = SetItemFieldType.class),
        @XmlElement(name = "DeleteItemField", required = true, type = DeleteItemFieldType.class),
        @XmlElement(name = "AppendToItemField", required = true, type = AppendToItemFieldType.class)
    })
