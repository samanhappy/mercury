...
public class NonEmptyArrayOfAlternateIdsType {
    ...
    @XmlElements({
        @XmlElement(name = "AlternatePublicFolderId", required = true, type = AlternatePublicFolderIdType.class),
        @XmlElement(name = "AlternateId", required = true, type = AlternateIdType.class),
        @XmlElement(name = "AlternatePublicFolderItemId", required = true, type = AlternatePublicFolderItemIdType.class)
    })
