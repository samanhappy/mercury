...
public class NonEmptyArrayOfFolderChangeDescriptionsType {
    ...
    @XmlElements({
        @XmlElement(name = "DeleteFolderField", required = true, type = DeleteFolderFieldType.class),
        @XmlElement(name = "AppendToFolderField", required = true, type = AppendToFolderFieldType.class),
        @XmlElement(name = "SetFolderField", required = true, type = SetFolderFieldType.class)
    })
