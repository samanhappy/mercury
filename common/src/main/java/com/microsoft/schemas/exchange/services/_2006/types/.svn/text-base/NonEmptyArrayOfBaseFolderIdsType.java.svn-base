...
public class NonEmptyArrayOfBaseFolderIdsType {
    ...
    @XmlElements({
        @XmlElement(name = "FolderId", required = true, type = FolderIdType.class),
        @XmlElement(name = "DistinguishedFolderId", required = true, type = DistinguishedFolderIdType.class)
    })
