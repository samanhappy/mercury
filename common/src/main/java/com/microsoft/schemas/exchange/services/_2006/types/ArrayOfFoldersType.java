...
public class ArrayOfFoldersType {
    ...
    @XmlElements({
        @XmlElement(name = "SearchFolder", required = true, type = SearchFolderType.class),
        @XmlElement(name = "TasksFolder", required = true, type = TasksFolderType.class),
        @XmlElement(name = "CalendarFolder", required = true, type = CalendarFolderType.class),
        @XmlElement(name = "ContactsFolder", required = true, type = ContactsFolderType.class),
        @XmlElement(name = "Folder", required = true, type = FolderType.class)
    })
